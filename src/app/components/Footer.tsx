...
import iconCall from "../../../public/iconCall.png";
import Image from "next/image";
import Link from "next/link";

const Footer = () => {
  return (
    <footer className=" select-none col-span-12 bg-[#48896E] rounded-3xl px-10 py-20 flex justify-between items-top gap-48">
      <Link href="/">
      ...
      <nav>
        <ul className="flex gap-6 text-xl">
          <li className="flex flex-col gap-4 min-w-[17.5rem]">
